...
Ultimatum Game [@guth1982experimental] is a simple bargaining game in which there are two players in distinct roles: **a proposer** and **a responder**. 

Briefly the game is played as follows:

- The proposer offers a division of a fixed amount of money between herself and the responder (Say 10 points).
